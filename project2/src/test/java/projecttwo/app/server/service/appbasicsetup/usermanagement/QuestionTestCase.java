...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("sRa7YXW3PS3AVfIKv2571Ua7lPOOArh6ePJ8NWojntRIVui0Ml");
        question.setQuestionDetails("tUJ2Zm8oOL");
        question.setLevelid(10);
        question.setQuestion("GRCt0LOt2O5yZtA3FrrR20uCLoyazDf8KjQfrdJXhYESGGc8hn");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("NKzluax9PDaIOScqqwjqRBtIObV5U7oUfswtbBdPj1gMka58Qn");
            question.setQuestionDetails("TQ5AS23fo0");
            question.setLevelid(10);
            question.setQuestion("DNqCpdejCTtsOqQMBVgFAmyQgviug6o21CEP7xZvtjhXuYi6uk");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 20));
        entityConstraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "fWVYUlQWuunPAo3wSdWf8LPctJStgTqqrBu1BrJzDI4pJOMpyxAYl771nw0UokqW3"));
