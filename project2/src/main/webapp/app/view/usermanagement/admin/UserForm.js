Ext.define('Project2.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project2.view.usermanagement.admin.AddUserDetailsViewModel', 'Project2.model.AddUserDataModel' ],
