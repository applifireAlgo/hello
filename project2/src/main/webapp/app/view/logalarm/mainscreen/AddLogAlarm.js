 ...
 * 
 */
Ext.define('Project2.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Project2.view.logalarm.mainscreen.AddLogAlarmController',
			'Project2.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Project2.view.logalarm.mainscreen.AppAlarmPanel',
