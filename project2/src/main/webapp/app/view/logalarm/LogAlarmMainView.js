 ...
 * 
 */
Ext.define('Project2.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Project2.view.logalarm.LogAlarmMainViewController',
			'Project2.view.logalarm.tree.LogAlarmTreePanel',
			'Project2.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
