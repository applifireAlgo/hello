Ext.define('Project2.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Project2.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Project2.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Project2.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Project2.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Project2.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Project2.view.clouddrive.CloudDrive");
    },
