 ...
 */
Ext.define('Project2.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project2.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project2.view.fw.component.DateTimePicker(o);
    },
