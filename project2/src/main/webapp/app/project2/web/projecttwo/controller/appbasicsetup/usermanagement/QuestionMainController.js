Ext.define('Project2.project2.web.projecttwo.controller.appbasicsetup.usermanagement.QuestionMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project2.project2.shared.projecttwo.model.appbasicsetup.usermanagement.QuestionModel',
               autoLoad: true,
