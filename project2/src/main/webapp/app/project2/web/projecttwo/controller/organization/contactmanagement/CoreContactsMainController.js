Ext.define('Project2.project2.web.projecttwo.controller.organization.contactmanagement.CoreContactsMainController', {
     extend: 'Project2.view.fw.frameworkController.AggregateViewController',
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project2.project2.shared.projecttwo.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: true,
