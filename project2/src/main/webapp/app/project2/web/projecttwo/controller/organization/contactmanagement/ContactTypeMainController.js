Ext.define('Project2.project2.web.projecttwo.controller.organization.contactmanagement.ContactTypeMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project2.project2.shared.projecttwo.model.organization.contactmanagement.ContactTypeModel',
               autoLoad: true,
