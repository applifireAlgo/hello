 ...
 */
Ext.define('Project2.Application', {
	...
	requires : [ "Ext.data.Model","Ext.app.ViewModel","Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Project2.view.databrowsercalendar.DBCalendar",
			"Project2.view.fw.component.CustomComboBox" ,"Project2.view.fw.component.TreeComponent"],
	...
	stores : [ 'Project2.store.QueryCriteriaWidgetsStore' ],
	...
	try{
		...
		if (responseText.alarm) {
			if (responseText.alarm.alarmID == "ABSAA254905401" && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Project2.view.login.SessionLogin').center();
