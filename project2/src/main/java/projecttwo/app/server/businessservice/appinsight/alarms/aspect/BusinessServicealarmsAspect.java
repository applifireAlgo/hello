package projecttwo.app.server.businessservice.appinsight.alarms.aspect;
import projecttwo.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicealarmsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projecttwo.app.server.businessservice.appinsight.alarms..*(..)) && !alarmOperation()")
    protected void allOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.businessservice.appinsight.alarms.AppLogAlarmGenerationBizService..*(..))")
