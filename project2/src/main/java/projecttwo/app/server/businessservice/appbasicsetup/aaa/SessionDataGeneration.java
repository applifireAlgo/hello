package projecttwo.app.server.businessservice.appbasicsetup.aaa;
...
public class SessionDataGeneration {
	...
	private String generateUserHash(final String _usidKey) {
	 ...
	 * @return
	 */
	public String generateQKeHash(final String loginId, final String userCredentials, final String sessionId, final HttpServletRequest request, final String _usidKey) {
