package projecttwo.app.server.businessservice.organization.contactmanagement.aspect;
...
public class BusinessServicecontactmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projecttwo.app.server.businessservice.organization.contactmanagement..*(..))")
