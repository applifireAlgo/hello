package projecttwo.app.server.businessservice.organization.locationmanagement.aspect;
...
public class BusinessServicelocationmanagementAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* projecttwo.app.server.businessservice.organization.locationmanagement..*(..))")
