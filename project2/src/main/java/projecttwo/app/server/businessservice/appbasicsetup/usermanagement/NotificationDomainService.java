...
import projecttwo.app.bean.EmailBean;

import projecttwo.app.bean.NotificationTemplate;

import projecttwo.app.shared.appbasicsetup.usermanagement.ArtAppNotificationTemplate;

import projecttwo.app.server.repository.appbasicsetup.usermanagement.ArtAppNotificationTemplateRepository;

import projecttwo.app.bean.SMSBean;

import projecttwo.app.bean.SMSData;

import projecttwo.app.server.repository.appbasicsetup.usermanagement.SMSConfigRepository;

import projecttwo.app.shared.appbasicsetup.usermanagement.SMSConfig;

import projecttwo.app.server.businessservice.appbasicsetup.usermanagement.SMSNotificationBusinessService;
...
public class NotificationDomainService {
	 ...
	 * 
	 * @param EmailBean
	 *            - CONTAINS THE RECIEVERS, ATTACHMENTS AND SUBJECT
	 * @param EmailTemplate
	 *            - CONTAINS TEMPLATE ID AND DYNAMIC REFERENCES
	 * 
	 * */
	public void sendMail(EmailBean emailBean, NotificationTemplate emailTemplate) throws Exception {
		if (emailBean.sizeOfRecipients() == 0) {
			throw new com.spartan.pluggable.exception.security.InvalidDataException();
		}
	 ...
	 * @throws Exception
	 */
	public boolean sendSMS(SMSBean smsBean, NotificationTemplate template) throws Exception {
