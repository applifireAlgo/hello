...
public class UserRoleBridgeRepositoryImpl extends SearchInterfaceImpl implements UserRoleBridgeRepository<UserRoleBridge> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        UserRoleBridge object = emanager.find(projecttwo.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge.class, id);
    ...
    public List<UserRoleBridge> findByRoleId(String roleId) throws Exception {
        ...
        java.util.List<projecttwo.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge> listOfUserRoleBridge = query.getResultList();
