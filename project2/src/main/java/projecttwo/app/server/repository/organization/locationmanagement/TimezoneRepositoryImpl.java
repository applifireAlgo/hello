...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for Timezone Master table Entity", complexity = Complexity.LOW)
public class TimezoneRepositoryImpl extends SearchInterfaceImpl implements TimezoneRepository<Timezone> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Timezone object = emanager.find(projecttwo.app.shared.organization.locationmanagement.Timezone.class, id);
