...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for ContactType Master table Entity", complexity = Complexity.LOW)
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        ContactType object = emanager.find(projecttwo.app.shared.organization.contactmanagement.ContactType.class, id);
