...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for Country Master table Entity", complexity = Complexity.LOW)
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Country object = emanager.find(projecttwo.app.shared.organization.locationmanagement.Country.class, id);
