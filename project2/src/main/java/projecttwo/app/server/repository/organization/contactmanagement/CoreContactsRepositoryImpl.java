...
public class CoreContactsRepositoryImpl extends SearchInterfaceImpl implements CoreContactsRepository<CoreContacts> {
    ...
    public CoreContacts save(CoreContacts entity) throws Exception {
        EntityManager emanager = emfResource.getResource();
        java.util.List<projecttwo.app.shared.organization.contactmanagement.CommunicationData> communicationdata = new java.util.ArrayList<projecttwo.app.shared.organization.contactmanagement.CommunicationData>();
        for (java.util.Iterator iterator = entity.getCommunicationData().iterator(); iterator.hasNext(); ) {
            projecttwo.app.shared.organization.contactmanagement.CommunicationData childEntity = (projecttwo.app.shared.organization.contactmanagement.CommunicationData) iterator.next();
            if (childEntity.getPrimaryKey() != null) {
                projecttwo.app.shared.organization.contactmanagement.CommunicationData ans = emanager.find(CommunicationData.class, childEntity.getPrimaryKey());
                communicationdata.add(ans);
            } else {
                communicationdata.add(childEntity);
            }
        }
        java.util.List<projecttwo.app.shared.organization.locationmanagement.Address> address = new java.util.ArrayList<projecttwo.app.shared.organization.locationmanagement.Address>();
        for (java.util.Iterator iterator = entity.getAddress().iterator(); iterator.hasNext(); ) {
            projecttwo.app.shared.organization.locationmanagement.Address childEntity = (projecttwo.app.shared.organization.locationmanagement.Address) iterator.next();
            if (childEntity.getPrimaryKey() != null) {
                projecttwo.app.shared.organization.locationmanagement.Address ans = emanager.find(Address.class, childEntity.getPrimaryKey());
                address.add(ans);
            } else {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        CoreContacts object = emanager.find(projecttwo.app.shared.organization.contactmanagement.CoreContacts.class, id);
    ...
    public void deleteCommunicationData(List<CommunicationData> communicationdata) {
        ...
        for (projecttwo.app.shared.organization.contactmanagement.CommunicationData _communicationdata : communicationdata) {
            projecttwo.app.shared.organization.contactmanagement.CommunicationData s = emanager.find(projecttwo.app.shared.organization.contactmanagement.CommunicationData.class, _communicationdata.getCommDataId());
            emanager.remove(s);
        }
    }
    ...
    public void deleteAddress(List<Address> address) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (projecttwo.app.shared.organization.locationmanagement.Address _address : address) {
            projecttwo.app.shared.organization.locationmanagement.Address s = emanager.find(projecttwo.app.shared.organization.locationmanagement.Address.class, _address.getAddressId());
            emanager.remove(s);
        }
    }
    ...
    public List<CoreContacts> findByTitleId(String titleId) throws Exception {
        ...
        java.util.List<projecttwo.app.shared.organization.contactmanagement.CoreContacts> listOfCoreContacts = query.getResultList();
