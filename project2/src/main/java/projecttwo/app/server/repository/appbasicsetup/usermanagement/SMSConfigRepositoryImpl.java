...
public class SMSConfigRepositoryImpl extends SearchInterfaceImpl implements SMSConfigRepository<SMSConfig> {
	...
	public void delete(String id) throws Exception {
		javax.persistence.EntityManager emanager = emfResource.getResource();
		SMSConfig s = emanager.find(SMSConfig.class, id);
		emanager.remove(s);
