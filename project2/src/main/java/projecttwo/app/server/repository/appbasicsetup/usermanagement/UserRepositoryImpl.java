...
public class UserRepositoryImpl extends SearchInterfaceImpl implements UserRepository<User> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        User object = emanager.find(projecttwo.app.shared.appbasicsetup.usermanagement.User.class, id);
    ...
    public void deletePassRecovery(List<PassRecovery> passrecovery) {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        for (projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery _passrecovery : passrecovery) {
            projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery s = emanager.find(projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery.class, _passrecovery.getPassRecoveryId());
            emanager.remove(s);
        }
    }
    ...
    public List<User> findByUserAccessLevelId(String userAccessLevelId) throws Exception {
        ...
        java.util.List<projecttwo.app.shared.appbasicsetup.usermanagement.User> listOfUser = query.getResultList();
