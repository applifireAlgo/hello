...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for CommunicationType Master table Entity", complexity = Complexity.LOW)
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        CommunicationType object = emanager.find(projecttwo.app.shared.organization.contactmanagement.CommunicationType.class, id);
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception {
        ...
        java.util.List<projecttwo.app.shared.organization.contactmanagement.CommunicationType> listOfCommunicationType = query.getResultList();
