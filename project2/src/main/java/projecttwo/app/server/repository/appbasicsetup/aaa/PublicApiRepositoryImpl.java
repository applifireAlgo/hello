...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for PublicApi Master table Entity", complexity = Complexity.LOW)
public class PublicApiRepositoryImpl extends SearchInterfaceImpl implements PublicApiRepository<PublicApi> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        PublicApi object = emanager.find(projecttwo.app.shared.appbasicsetup.aaa.PublicApi.class, id);
