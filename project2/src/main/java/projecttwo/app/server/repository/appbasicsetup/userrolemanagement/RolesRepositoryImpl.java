...
public class RolesRepositoryImpl extends SearchInterfaceImpl implements RolesRepository<Roles> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Roles object = emanager.find(projecttwo.app.shared.appbasicsetup.userrolemanagement.Roles.class, id);
    ...
    public void deleteRoleMenuBridge(List<RoleMenuBridge> rolemenubridge) {
        ...
        for (projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge _rolemenubridge : rolemenubridge) {
            projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge s = emanager.find(projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge.class, _rolemenubridge.getRoleMenuMapId());
            emanager.remove(s);
        }
    }
