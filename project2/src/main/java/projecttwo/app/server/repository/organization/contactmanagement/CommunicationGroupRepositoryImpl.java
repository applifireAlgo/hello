...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Repository for CommunicationGroup Master table Entity", complexity = Complexity.LOW)
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        CommunicationGroup object = emanager.find(projecttwo.app.shared.organization.contactmanagement.CommunicationGroup.class, id);
