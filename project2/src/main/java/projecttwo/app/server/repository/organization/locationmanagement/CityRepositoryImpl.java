...
public class CityRepositoryImpl extends SearchInterfaceImpl implements CityRepository<City> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        City object = emanager.find(projecttwo.app.shared.organization.locationmanagement.City.class, id);
    ...
    public List<City> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<projecttwo.app.shared.organization.locationmanagement.City> listOfCity = query.getResultList();
