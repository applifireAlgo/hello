...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "3", comments = "Service for Login Transaction table", complexity = Complexity.MEDIUM)
...
public class LoginServiceImpl extends LoginService {
    ...
    public HttpEntity<ResponseBean> FindUnMappedUser() throws Exception {
        java.util.List<projecttwo.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.FindUnMappedUser();
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
    ...
    public HttpEntity<ResponseBean> FindMappedUser() throws Exception {
        java.util.List<projecttwo.app.shared.appbasicsetup.usermanagement.Login> lstlogin = loginrepo.FindMappedUser();
        AppAlarm appAlarm = Log.getAlarm("ABSUM124990200");
        ResponseBean responseBean = new ResponseBean(appAlarm);
        responseBean.add("message", String.format(appAlarm.getMessage(), "Login"));
        responseBean.add("data", lstlogin);
