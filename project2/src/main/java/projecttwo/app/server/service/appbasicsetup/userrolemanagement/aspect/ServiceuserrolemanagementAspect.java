package projecttwo.app.server.service.appbasicsetup.userrolemanagement.aspect;
import projecttwo.app.server.service.aspect.ServiceAspect;
...
public class ServiceuserrolemanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.appbasicsetup.userrolemanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
