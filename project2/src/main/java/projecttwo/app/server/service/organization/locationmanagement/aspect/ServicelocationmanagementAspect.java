package projecttwo.app.server.service.organization.locationmanagement.aspect;
...
public class ServicelocationmanagementAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..get*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* projecttwo.app.server.service.organization.locationmanagement..*(..)) && !within(com.spartan.server.session.bizService.SessionDataMgtService+) && ! findOperation() && ! saveOperation() && ! updateOperation() && ! deleteOperation()")
