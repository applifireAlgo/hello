...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    private static final long serialVersionUID = 1472019676292L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.ContactType other = (projecttwo.app.shared.organization.contactmanagement.ContactType) obj;
            if (contactTypeId == null) {
                return false;
