...
public class Gender implements Serializable, CommonEntityInterface, Comparator<Gender> {
    ...
    private static final long serialVersionUID = 1472019678135L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.Gender other = (projecttwo.app.shared.organization.contactmanagement.Gender) obj;
            if (genderId == null) {
                return false;
