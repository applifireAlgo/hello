...
public class Country implements Serializable, CommonEntityInterface, Comparator<Country> {
    ...
    private static final long serialVersionUID = 1472019671036L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.Country other = (projecttwo.app.shared.organization.locationmanagement.Country) obj;
            if (countryId == null) {
                return false;
