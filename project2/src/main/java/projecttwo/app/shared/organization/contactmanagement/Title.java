...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    private static final long serialVersionUID = 1472019679833L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.Title other = (projecttwo.app.shared.organization.contactmanagement.Title) obj;
            if (titleId == null) {
                return false;
