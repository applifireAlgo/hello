package projecttwo.app.shared.organization.locationmanagement;
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    private static final long serialVersionUID = 1472019674370L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.AddressType other = (projecttwo.app.shared.organization.locationmanagement.AddressType) obj;
            if (addressTypeId == null) {
                return false;
