...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    private static final long serialVersionUID = 1472019684376L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.CommunicationData other = (projecttwo.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
