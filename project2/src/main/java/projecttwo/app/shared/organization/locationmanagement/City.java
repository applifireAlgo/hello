...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    private static final long serialVersionUID = 1472019673411L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.City other = (projecttwo.app.shared.organization.locationmanagement.City) obj;
            if (cityId == null) {
                return false;
