...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    private static final long serialVersionUID = 1472019677498L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.CommunicationType other = (projecttwo.app.shared.organization.contactmanagement.CommunicationType) obj;
            if (commType == null) {
                return false;
