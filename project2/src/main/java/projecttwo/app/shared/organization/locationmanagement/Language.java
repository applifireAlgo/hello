...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    private static final long serialVersionUID = 1472019669511L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.Language other = (projecttwo.app.shared.organization.locationmanagement.Language) obj;
            if (languageId == null) {
                return false;
