...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    private static final long serialVersionUID = 1472019672161L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.State other = (projecttwo.app.shared.organization.locationmanagement.State) obj;
            if (stateId == null) {
                return false;
