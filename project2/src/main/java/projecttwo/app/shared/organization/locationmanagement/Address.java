...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    private static final long serialVersionUID = 1472019675254L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.Address other = (projecttwo.app.shared.organization.locationmanagement.Address) obj;
            if (addressId == null) {
                return false;
