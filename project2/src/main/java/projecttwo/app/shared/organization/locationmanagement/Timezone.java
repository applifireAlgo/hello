...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    private static final long serialVersionUID = 1472019667972L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.locationmanagement.Timezone other = (projecttwo.app.shared.organization.locationmanagement.Timezone) obj;
            if (timeZoneId == null) {
                return false;
