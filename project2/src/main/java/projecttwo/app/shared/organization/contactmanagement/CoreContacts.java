...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    private static final long serialVersionUID = 1472019681214L;
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<projecttwo.app.shared.organization.contactmanagement.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<projecttwo.app.shared.organization.locationmanagement.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.organization.contactmanagement.CoreContacts other = (projecttwo.app.shared.organization.contactmanagement.CoreContacts) obj;
            if (contactId == null) {
                return false;
