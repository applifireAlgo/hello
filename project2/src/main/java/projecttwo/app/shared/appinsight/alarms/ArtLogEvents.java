package projecttwo.app.shared.appinsight.alarms;
...
public class ArtLogEvents implements Serializable {
	...
	public ArtLogEvents(String logeventId, Timestamp eventDateTime, Date eventDate, String alarmId, String customerId, String userId, String userIpAddress, int userPort, double geoLatitude,
			...
			String exception, int context, int severity, int layerId, int eventAction, int alarmStatus) {
		super();
	...
	public String toString() {
		return "ArtLogAlarmEvents [logeventId=" + logeventId + ", eventDateTime=" + eventDateTime + ", eventDate=" + eventDate + ", alarmId=" + alarmId + ", customerId=" + customerId + ", userId=" + userId + ", userIpAddress="
				...
				+ message + ", exception=" + exception + ", context=" + context + ", severity=" + severity + ", layerId=" + layerId + ", eventAction=" + eventAction + ", alarmStatus="
				+ alarmStatus + "]";
	}
