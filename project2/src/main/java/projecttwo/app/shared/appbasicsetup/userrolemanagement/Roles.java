...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    private static final long serialVersionUID = 1472019697206L;
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.userrolemanagement.Roles other = (projecttwo.app.shared.appbasicsetup.userrolemanagement.Roles) obj;
            if (roleId == null) {
                return false;
