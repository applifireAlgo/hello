...
public class JwtConfig implements Serializable, CommonEntityInterface, Comparator<JwtConfig> {
    ...
    private static final long serialVersionUID = 1472019701250L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.aaa.JwtConfig other = (projecttwo.app.shared.appbasicsetup.aaa.JwtConfig) obj;
            if (configId == null) {
                return false;
