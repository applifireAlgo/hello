package projecttwo.app.shared.appbasicsetup.usermanagement;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    private static final long serialVersionUID = 1472019688680L;
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.User other = (projecttwo.app.shared.appbasicsetup.usermanagement.User) obj;
            if (userId == null) {
                return false;
