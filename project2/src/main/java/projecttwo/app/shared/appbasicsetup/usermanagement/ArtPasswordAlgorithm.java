...
public class ArtPasswordAlgorithm implements Serializable, Comparator<ArtPasswordAlgorithm> {
	...
	public void setAlgorithm(final Integer _algorithm) {
		if (_algorithm != null) {
	...
	public void setAlgoName(final String _algoName) {
		if (_algoName != null) {
	...
	public void setAlgoDescription(final String _algoDescription) {
	...
	public void setAlgoId(final String _algoId) {
		this.algoId = _algoId;
	}
