...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    private static final long serialVersionUID = 1472019684716L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.PasswordAlgo other = (projecttwo.app.shared.appbasicsetup.usermanagement.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
