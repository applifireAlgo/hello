...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    private static final long serialVersionUID = 1472019696985L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.SessionData other = (projecttwo.app.shared.appbasicsetup.usermanagement.SessionData) obj;
            if (dataId == null) {
                return false;
