...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    private static final long serialVersionUID = 1472019686533L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.UserAccessLevel other = (projecttwo.app.shared.appbasicsetup.usermanagement.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
