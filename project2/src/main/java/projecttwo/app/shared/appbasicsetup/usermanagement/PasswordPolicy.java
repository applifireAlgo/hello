...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    private static final long serialVersionUID = 1472019685321L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.PasswordPolicy other = (projecttwo.app.shared.appbasicsetup.usermanagement.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
