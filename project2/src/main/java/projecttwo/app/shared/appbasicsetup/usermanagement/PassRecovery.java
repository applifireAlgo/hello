...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    private static final long serialVersionUID = 1472019694820L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery other = (projecttwo.app.shared.appbasicsetup.usermanagement.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
