...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    private static final long serialVersionUID = 1472019687643L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.UserAccessDomain other = (projecttwo.app.shared.appbasicsetup.usermanagement.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
