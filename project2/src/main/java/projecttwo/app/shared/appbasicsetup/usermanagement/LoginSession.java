...
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    private static final long serialVersionUID = 1472019694628L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.LoginSession other = (projecttwo.app.shared.appbasicsetup.usermanagement.LoginSession) obj;
            if (appSessionId == null) {
                return false;
