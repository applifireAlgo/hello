...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    private static final long serialVersionUID = 1472019685995L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.Question other = (projecttwo.app.shared.appbasicsetup.usermanagement.Question) obj;
            if (questionId == null) {
                return false;
