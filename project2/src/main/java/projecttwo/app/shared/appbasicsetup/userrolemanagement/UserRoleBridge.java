...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    private static final long serialVersionUID = 1472019700237L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge other = (projecttwo.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
