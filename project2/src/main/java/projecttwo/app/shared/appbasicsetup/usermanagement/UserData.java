...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    private static final long serialVersionUID = 1472019696239L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.UserData other = (projecttwo.app.shared.appbasicsetup.usermanagement.UserData) obj;
            if (userDataId == null) {
                return false;
