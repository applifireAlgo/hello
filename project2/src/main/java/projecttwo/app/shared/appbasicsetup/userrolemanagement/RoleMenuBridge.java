package projecttwo.app.shared.appbasicsetup.userrolemanagement;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "5", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    private static final long serialVersionUID = 1472019699783L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge other = (projecttwo.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
