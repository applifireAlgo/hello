...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    private static final long serialVersionUID = 1472019691529L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.usermanagement.Login other = (projecttwo.app.shared.appbasicsetup.usermanagement.Login) obj;
            if (loginPk == null) {
                return false;
