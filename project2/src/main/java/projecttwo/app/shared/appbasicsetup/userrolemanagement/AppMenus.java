...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    private static final long serialVersionUID = 1472019699354L;
    ...
    public boolean equals(Object obj) {
        try {
            projecttwo.app.shared.appbasicsetup.userrolemanagement.AppMenus other = (projecttwo.app.shared.appbasicsetup.userrolemanagement.AppMenus) obj;
            if (menuId == null) {
                return false;
